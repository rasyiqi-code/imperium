...
export default function AdminSettings() {
  ...
  return (
    <div className="p-4 md:p-8 space-y-6 max-w-5xl mx-auto pb-32 bg-transparent text-white font-sans text-left text-xs md:text-sm animate-in fade-in duration-300">
