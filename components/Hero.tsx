...
export default function Hero() {
  return (
    <section className="relative text-white overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-yellow-500/5 rounded-full blur-[150px] pointer-events-none z-0" />
      
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-8 md:py-12 min-h-[calc(100vh-80px)] flex flex-col justify-between">
        {/* Konten Utama - Berpusat secara vertikal */}
        <div className="flex-grow flex flex-col justify-center items-center my-auto py-6">
          ...
          <div className="mb-6 flex justify-center items-center relative">
            ...
            <svg 
              className="absolute w-[180px] h-[180px] text-yellow-500/10 animate-rotate-slow pointer-events-none z-0" 
              viewBox="0 0 200 200" 
              fill="none" 
            ...
            {/* Logo utama aplikasi */}
            <div className="relative z-10 p-2.5 rounded-full bg-black/60 border border-yellow-500/20 shadow-[0_0_30px_rgba(234,179,8,0.15)]">
              <Image
                src="/logo.png"
                alt="Imperium Crypto"
                width={72}
          ...
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-yellow-500/25 bg-yellow-500/5 px-4.5 py-2 text-[10px] font-bold uppercase tracking-widest text-yellow-400 shadow-[0_0_15px_rgba(234,179,8,0.08)]">
            <ShieldCheck className="h-3.5 w-3.5" />
            Media Digital & Edukasi Crypto
          </div>

          {/* Headline - Gradasi Emas Metalik Premium & Tracking Tighter */}
          <h1 className="mb-4 text-balance text-center text-3xl font-black leading-tight tracking-tighter md:text-4xl lg:text-5xl text-white">
            Fondasi Pengetahuan{" "}
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row w-full max-w-md mx-auto sm:max-w-none">
            <a
              href="#pricing"
              className="group relative inline-flex w-full sm:w-auto items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 px-8 py-4 font-bold uppercase tracking-wider text-black transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_0_40px_rgba(234,179,8,0.35)] active:scale-[0.98]"
            >
        ...
        {/* Feature strip - Grid 3 kolom premium di bagian bawah fold */}
        <div className="mt-8 md:mt-12 grid grid-cols-1 gap-4 sm:grid-cols-3 w-full">
          <Feature
            icon={<BookOpen />}
...
function Feature({
  ...
  return (
    ...
    <div className="group relative flex flex-col items-center rounded-3xl border border-white/[0.06] bg-[#0d0d0d]/40 backdrop-blur-md px-6 py-6 text-center transition-all duration-500 hover:border-yellow-500/30 hover:shadow-[0_8px_30px_rgba(234,179,8,0.04)] hover:scale-[1.02]">
      ...
      <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-2xl bg-yellow-500/5 border border-yellow-500/15 text-yellow-400 group-hover:bg-yellow-500/10 group-hover:border-yellow-500/30 transition-all duration-300">
        {icon}
      </div>
      <h3 className="mb-1.5 font-bold text-white uppercase tracking-tight text-xs">{title}</h3>
